  ...
  return (
    ...
    <Accordion className="acord" defaultActiveKey="0">
      ...
      <Accordion.Item eventKey="2">
        <Accordion.Header className="font_bold fs-20 text-dark">
          Can mentors provide guidance on specific legal specialties or
          career paths ?
        </Accordion.Header>
        <Accordion.Body className="font_regular fs_12 text-gey">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
      ...
      <Accordion.Item eventKey="4">
        <Accordion.Header className="font_bold fs-20 text-dark">
          Is there a support system in place for mentees who may have
          questions or need assistance while using the app?
        </Accordion.Header>
        <Accordion.Body className="font_regular fs_12 text-gey">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
